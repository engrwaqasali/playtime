...
const FirePlayMobile: React.FC<FirePlayProps> = ({ close }) => {
    useStyles(s);
    ...
    return (
        <div className={cnFirePlay()}>
            ...
            <div className={cnFirePlay('Container')}>
                <div className={cnFirePlay('Description')}>
                    ...
                    <div className={cnFirePlay('Description-Row')}>
                        <Text color="white">
                            Подобно тому, как вы разрезали колоду в реальном казино, мы разрешаем вам выбирать
                            «клиентский сид». Эта реализация дает вам полное спокойствие во время игры, зная, что мы не
                            можем «подстраивать» ставки в нашу пользу.
                        </Text>
                    </div>
                    <div className={cnFirePlay('Description-Row')}>
                        <Text color="white">
                            Вы можете узнать больше о том, как этот алгоритм хеширования обеспечивает полную
