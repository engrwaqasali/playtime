...
export interface MinesGamePropsMobile {
    fieldSize: number;
...
const cnMinesGameMobile = cn(s, 'MinesGame');

const MinesGameMobile: React.FC<MinesGamePropsMobile> = ({
    fieldSize,
    minBombsCount,
    coefs,
    formBombsCount,
    ...
    return (
        <div className={cnMinesGameMobile()}>
            <div className={cnMinesGameMobile('Main')}>
                <div className={cnMinesGameMobile('Field')}>
                ...
                <div className={cnMinesGameMobile('Counters')}>
...
export default MinesGameMobile;
